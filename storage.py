...
class Storage():
	...
	def delete_tbl(self, tbl_name: str, cascade = True):
...
if __name__ == '__main__':
	...
	if len(sys.argv) == 2 and sys.argv[1] == 'test':
		...
		# sto.delete_tbl('x_1/1_new')
		# for x in range(5): sto.delete_tbl('x_' + str(x))
